...
for i in comp_sizes:
  ...
  if i!=2:
    ...
    plt.scatter(x=pca_file[:,0],y=pca_file[:,1],c=kmeans_20)
    plt.title("PCA 2D usando k = 20")
    plt.xlabel("Dim 1")
    plt.ylabel("Dim 2")
    plt.show()
    plt.scatter(x=pca_file[:,0],y=pca_file[:,1],c=kmeans_50)
...
for i in comp_sizes:
  ...
  if i!=2:
    ...
    plt.scatter(x=umap_file[:,0],y=umap_file[:,1],c=kmeans_20)
    plt.title("UMAP 2D usando k = 20")
    plt.xlabel("Dim 1")
    plt.ylabel("Dim 2")
    plt.show()
    plt.scatter(x=umap_file[:,0],y=umap_file[:,1],c=kmeans_50)
